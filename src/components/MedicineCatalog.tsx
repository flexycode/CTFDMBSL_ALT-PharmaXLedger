...
const mockMedicines: Medicine[] = [
  {
    ...
    inStock: true,
    imageUrl: '/assets/medicines/ambroxol.jpg',
    batch_order_id: "1",
    supplier_id: "1",
    warehouse_id: "1",
    inventory: [
  ...
  },
  {
    ...
    inStock: true,
    imageUrl: '/assets/medicines/amlodipine.jpg',
  },
  {
    id: "3",
    ...
    manufacturer: "TGP Pharma Inc.",
    inStock: true,
    imageUrl: '/assets/medicines/asmagone-salbutamol-sulfate.jpg',
  },
  {
    id: "4",
    ...
    manufacturer: "TGP Pharma Inc.",
    inStock: true,
    imageUrl: '/assets/medicines/benedex-amoxicillin.jpg',
  },
  {
    id: "5",
    ...
    inStock: true,
    imageUrl: '/assets/medicines/butamirate-citrate.png',
  },
  {
    id: "6",
    ...
    manufacturer: "Actimed Pharmaceuticals",
    inStock: true,
    imageUrl: '/assets/medicines/butamirate-citrate-tablet.jpg',
  },
  {
    id: "7",
    ...
    manufacturer: "TGP Pharma Inc.",
    inStock: true,
    imageUrl: '/assets/medicines/cepham-cefalexin-cap.jpg',
  },
  {
    id: "8",
    ...
    manufacturer: "TGP Pharma Inc.",
    inStock: true,
    imageUrl: '/assets/medicines/dextro-dextromethorphan-tablet.jpg',
  },
  {
    id: "9",
    ...
    manufacturer: "TGP Pharma Inc.",
    inStock: true,
    imageUrl: '/assets/medicines/guaiflem-guaifenesin.jpg',
  },
  {
    id: "10",
    ...
    manufacturer: "TGP Pharma Inc.",
    inStock: true,
    imageUrl: '/assets/medicines/lemoncee-ascorbic-acid-drops.jpg',
  },
  {
    id: "11",
    name: "Losartan",
    ...
    price: 380.50,
    category: "cardiovascular",
    manufacturer: "RiteMED Phils. Inc.",
    inStock: true,
    imageUrl: '/assets/medicines/losartan.png',
  },
  {
    id: "12",
    name: "Acetylcysteine",
    description: "Mucolytic agent used to help clear mucus from the airways.",
    price: 210.00,
    category: "respiratory",
    manufacturer: "RiteMED Phils. Inc.",
    inStock: true,
    imageUrl: '/assets/medicines/acetylcysteine-powder.jpg',
  },
  {
    id: "13",
    name: "Carbocisteine",
    description: "Mucolytic used to treat respiratory tract disorders.",
    price: 185.00,
    category: "respiratory",
    manufacturer: "RiteMED Phils. Inc.",
    inStock: true,
    imageUrl: '/assets/medicines/carbocisteine.png',
  },
  {
    id: "14",
    name: "Diamet (Metformin)",
    description: "Used to control high blood sugar in people with type 2 diabetes.",
    price: 120.00,
    category: "antidiabetic",
    manufacturer: "RiteMED Phils. Inc.",
    inStock: true,
    imageUrl: '/assets/medicines/diamet-metformin.jpg',
  },
  {
    id: "15",
    name: "Megaline (Mefenamic Acid)",
    description: "Non-steroidal anti-inflammatory drug for pain relief.",
    price: 90.00,
    category: "pain relief",
    manufacturer: "RiteMED Phils. Inc.",
    inStock: true,
    imageUrl: '/assets/medicines/megalin-mefenamic.jpg',
  },
  {
    id: "16",
    name: "Myrex (Carbocisteine)",
    description: "Mucolytic used to treat respiratory tract disorders.",
    price: 180.00,
    category: "respiratory",
    manufacturer: "RiteMED Phils. Inc.",
    inStock: true,
    imageUrl: '/assets/medicines/myrex-carbocisteine.jpg',
  },
  {
    id: "17",
    name: "Nepidol (Amlodipine)",
    description: "Calcium channel blocker for high blood pressure.",
    price: 350.00,
    category: "cardiovascular",
    manufacturer: "RiteMED Phils. Inc.",
    inStock: true,
    imageUrl: '/assets/medicines/nepidol-amlodipine.jpg',
  },
  {
    id: "18",
    name: "Trimacort (Clotrimazole)",
    description: "Antifungal medication for skin infections.",
    price: 95.00,
    category: "antifungal",
    manufacturer: "RiteMED Phils. Inc.",
    inStock: true,
    imageUrl: '/assets/medicines/trimacort-clotrimazole.jpg',
  },
  {
    id: "19",
    name: "Losartan (Potassium Amlodipine)",
    description: "Used to treat high blood pressure.",
    price: 400.00,
    category: "cardiovascular",
    manufacturer: "RiteMED Phils. Inc.",
    inStock: true,
    imageUrl: '/assets/medicines/losartan-potassium-amlodipine.jpg',
  },
];
