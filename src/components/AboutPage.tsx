                  ...
                  <CardContent>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">info@pharmaxledger.com</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start mt-4">
                      ...
                      <div className="ml-3">
                        ...
                        <a
                          href="https://github.com/artificial-ledger-technology"
                          target="_blank"
                    ...
                    <div className="flex items-start mt-4">
                      ...
                      <div className="ml-3">
                        ...
                        <a
                          href="https://www.linkedin.com/in/flexycode/"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-blue-600 hover:underline"
                        >
                          linkedin.com/in/flexycode
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start mt-4">
                      ...
                      <div className="ml-3">
                        ...
                        <a
                          href="http://facebook.com/AlphaOmegaCSDev?_rdc=1&_rdr"
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-blue-600 hover:underline"
                        >
                          facebook.com/AlphaOmegaCSDev
                        </a>
                      </div>
                    </div>
                  </CardContent>
