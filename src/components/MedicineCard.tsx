        ...
        <div className="relative h-36 overflow-hidden bg-gray-100">
          <img
            ...
            onError={(e) => {
              ...
              e.currentTarget.src = '/assets/medicines/default.jpg';
            }}
          />
          <Badge
              ...
              <div className="grid gap-4 py-4">
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <Input
                    id="email"
                    type="email"
                    placeholder="metamask@sugoi.com"
                    className="col-span-3"
                    required
                  />
                </div>
      ...
      <Dialog open={detailsOpen} onOpenChange={setDetailsOpen}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              <span className="text-right font-medium">Manufacturer:</span>
              <span className="col-span-3">{manufacturer}</span>
            </div>

            <div className="grid grid-cols-4 items-center gap-4">
              <span className="text-right font-medium">Price:</span>
              <span className="col-span-3">₱{price.toFixed(2)}</span>
            </div>

            <div className="grid grid-cols-4 items-center gap-4">
              <span className="text-right font-medium">Availability:</span>
