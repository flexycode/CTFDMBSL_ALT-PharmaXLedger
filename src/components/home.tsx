...
const Home = () => {
  ...
  const [userName, setUserName] = useState("Admin"); // Updated default name
  ...
  const navigateToCatalogSection = () => {
    // Scroll to the catalog section smoothly
  ...
  // Function to open cart programmatically
            ...
            <div className="md:hidden mt-3 pb-3">
              ...
              <div className="flex flex-col space-y-2">
                <button
                  ...
                  onClick={navigateToCatalogSection}
                >
                  Browse Catalog
                </button>
                <button
              ...
              <div className="relative z-10">
                <div className="max-w-3xl">
                  ...
                  <p className="text-gray-600 mb-6">
                    ...
                    management. Browse our extensive catalog of generic
                    medicines with real-time inventory tracking.
                  </p>
              ...
              <Tabs defaultValue="all" className="mb-6">
                ...
                {categories.map((category) => (
                  <TabsContent key={category.id} value={category.id}>
                    <MedicineCatalog openCart={openCart}
